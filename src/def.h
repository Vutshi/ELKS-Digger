...
#define BONUSES 1
/*
 * ELKS capacity build: the built-in DOS levels contain at most seven
 * bags.  Keeping the original DOS capacity elsewhere preserves behavior
 * for editors/custom levels while avoiding a large ELKS near-data load.
 * Custom ELKS levels with more than seven bags will ignore extras.
 */
#ifdef DIGGER_ELKS
#define BAGS 7
#else
